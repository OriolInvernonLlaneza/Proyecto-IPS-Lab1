...
public class VentanaAlmacenero extends JFrame {
	...
	//M�todo para a�adir las filas correspondientes en la tabla de pedidos
	...
	//M�todo usando la estructura de nico que aplica los principios de internacionalizacion a la aplicacion.
