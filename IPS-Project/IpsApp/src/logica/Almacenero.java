...
public class Almacenero {
	...
	public void marcarParaEmpaquetar(OrdenDeTrabajo ot) throws SQLException {
		//Se marca para empaquetar, lo cual no significa que se vaya a empaquetar, primero hay que comprobar que los productos recogidos son los que había en la OT
